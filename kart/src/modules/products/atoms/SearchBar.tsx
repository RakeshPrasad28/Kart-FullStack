  ...
  return (
    <View style={styles.container}>
      <Pressable onPress={()=>goBack()}>
        <Icon size={24} iconFamily='MaterialCommunityIcons' name='arrow-left' color='#000'/>
      </Pressable>
      ...
      <Icon name='heart-outline' size={24} iconFamily='Ionicons' color='#000'/>
      <Pressable onPress={()=>navigate('Cart')}>
        <Icon name='cart-sharp' size={24} iconFamily='Ionicons' color='#000'/>
        {cartLength > 0 && 
